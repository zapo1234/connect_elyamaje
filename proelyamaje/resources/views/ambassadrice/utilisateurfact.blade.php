                        ...
                        <table id="example" class="d-none table_mobile_responsive table table-striped table-bordered" style="width:100%">
                           <thead>
                              <tr>
                                 ...
                                 <th scope="col" class="cxp{{ Auth()->user()->is_admin }}">Nbr de vente/code live</th>
                                 <th scope="col" class="cxp{{ Auth()->user()->is_admin }}">Nbr de vente/code élève </th>
                                 <th scope="col" class="cxp{{ Auth()->user()->is_admin }}">Nbr de lives</th>
                                 <th scope="col" class="cxp{{ Auth()->user()->is_admin }}">Type</th>
                           ...
                           <tbody>
                              @foreach($users as $resultat)
                                 <tr class="{{ number_format($resultat['somme'], 2, '.', '') }}">
                                    ...
                                    <td data-label="User">{{ $resultat['name'] }}</td>
                                    <td data-label="Nbr de vente/code live" class="cxp{{ Auth()->user()->is_admin   }}">{{ $resultat['nbrslive']  }} </td>
                                    <td data-label="Nbr de vente/code élève" class="cxp{{ Auth()->user()->is_admin   }}">{{ $resultat['nbrseleve'] }}</td>
                                    <td data-label="Nbr de (live/mensuel)" class="cxp{{ Auth()->user()->is_admin   }}">{{ $resultat['nbrsfois'] }}</td>
                                    ...
                                    <td style="vertical-align:middle" data-label="Virement" class="cxp{{ Auth()->user()->is_admin }}{{ $resultat['is_admin'] }}">
                                    @if($resultat['csss'] == "actifpay")   
                                       <span class="aa{{ $resultat['nbrslive'] }}{{ $resultat['nbrseleve'] }}">
                                             Consulter le Super Admin
                                          </span>
                                          <br/> 
                                        
                                      @endif
                                    </td>
                                    <td style="vertical-align:middle" data-label="Carte Cadeau" class="cxp{{ Auth()->user()->is_admin }} {{ $resultat['is_admin'] }}">
                                       @if($resultat['csss'] == "giftpay" || $resultat['csss'] == "actifpay")   
                                          <span class="{{ $resultat['nbrseleve'] }}">
                                             <button type="button"  id="facture{{ $resultat['id'] }}" class="btn btn-dark px-1 p-1 validerbon{{ $resultat['css'] }}" data-id3="{{ $resultat['id'] }},{{ $resultat['name'] }},{{ $resultat['is_admin']}},{{ $resultat['somme']}}, {{ $resultat['id_ambassadrice'] }},{{ $resultat['email'] }}">Payer par carte cadeaux</button>
                                          </span>
                                          <br/> 
