		...
		<div class="page-wrapper">
			...
			<div class="page-content">
				...
				<!-- <div class="cards_mobile">
				    ...
				    <h1 style="font-size:17px">Lister des ventes des codes élèves</h1>

				    

				    

				    <form style="margin-bottom:20px" action="/ambassadrice/orders/parainage">

				     @csrf

				    <input type="text" class="form-control" id="search_name" name="search_name" style="width:230px" aria-describedby="emailHelp" placeholder="Nom de l'élève..">
								...
								<div class="d-flex align-items-center">
									...
									<div>
										...
										<p style="margin-top:10px"> 
										 ...
										 <span class="dscom" style="padding-left:25%;color:green">commission  + {{ number_format($resultat->somme, 2, ',', '') }} € </span>
