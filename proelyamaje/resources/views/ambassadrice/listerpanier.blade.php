				...
				<div class="ps-3">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb mb-0 pe-3">
							<li class="breadcrumb-item active" aria-current="page">Lister les paniers</li>
						</ol>
					</nav>
				</div>
									...
									<tr>
										...
										<td data-label="Actions">
											<div class="d-flex order-actions">
												<a href="{{ route('ambassadrice.editpanier', ['id'=>$values['id']]) }}" title="Modifier les informations" class=""><i class='bx bxs-edit'></i></a>
