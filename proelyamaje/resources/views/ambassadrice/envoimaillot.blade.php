            ...
            <table style="max-width:700px;border-style:solid; border-width:1px; border-color:#c9c9c9;" width="100%" border="0" cellspacing="0" cellpadding="25">
                <tr>
                    <td align="center">
                        ...
                        <div>
                        <h1>Point de votre activité pour la période de <strong>Septembre 2023</strong></h1>
                        <p>Bonjour chère  <strong>Ambassadrice</strong></p>
                        ...
                        <div style="font-size:24px;font-weight:bold;"> 30 </div></div>
                        ...
                        <td>
                        <p style="width:80%;margin-left:2%;">La meilleur commande pour les code élèves à été réalisée par l'elève : <br/><strong>ZAPO martial</strong> pour un montant <strong> 100 euro</strong> </p>
                        </td>
                        </tr>
                        <tr style="height:50px">
                        <td>
                        <p style="width:80%;margin-left:2%;">La meilleur commande pendant vos lives ont été réalisé par la cliente : <br/><strong>Adrien Lyes</strong> pour un montant <strong> 400 euro</strong> </p>
                       </td>
                       </tr>
                       <tr>
                        <td>
