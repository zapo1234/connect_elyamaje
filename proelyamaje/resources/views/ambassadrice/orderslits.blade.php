...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3">Suivi de commande client mois en cours </h1>
    ...
    <button style="background-color:black;color:white;border:2px solid black;margin-left:50%;border-radius:15px;"><i class="fas fa-download fa-sm text-white-50"></i><a href ="{{ route('ambassadrice.account')  }}" style="color:white;">Créer un code promo élève</a></button><br/>
      <div class="h3" style="margin-top:20px;">commandes en cours réalisées par  des élèves </div>
            ...
            <div class="" style="border:1px solid #eee" width="500px" height:"180px">
                <div class="card-body" id="list">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text">
                             Réalisée le <br/>{{ $resultat->datet}}</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $resultat->customer }}</br/>
                                <div>Code Promo</div>
                                <span class="der" style="color:green"> {{ $resultat->code_promo }}</span><br/>
                               <span class="dscom" style="padding-left:60%;">{{ number_format($resultat->somme, 2, ',', '') }} € </span>
        ...
        <div class="col-xl-8 col-lg-7">
            <div class="card shadow mb-4" id="account_body">
                ...
                <div
                    ...
                    <h6 class="m"><i style="font-size:13px" class="fa">&#xf044;</i> Listes des achats clients  <span class="recher"></span></h6>
             ...
             @foreach($users as $resultat)
             <tr>
               <th scope="row">Achat réalisé le <br/>{{ $resultat->datet }}</th>
