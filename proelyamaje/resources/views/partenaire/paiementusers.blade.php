                              ...
                              <img id="imj" src="https://www.erp.elyamaje.com/admin/img/Logo_elyamaje.png" width="95px";
				             	...
				             	height="auto">
									...
									<div class="login-separater text-center mb-4">
										...
										<div>Confirmer le choix du bon d'achat </div>
                                    </div>
	...
	<div class="modal fade" id="modalPaiementUser" tabindex="-1" role="dialog" aria-labelledby="modalPaiementUserTitle" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document">
			...
			<div class="modal-header">
				<h5 class="modal-title" id="modalPaiementUserTitle">Confirmer le choix</h5>
			</div>
				<form  method="POST" class="d-flex flex-column align-items-center w-100" id="form_id" action="/notifications/choix/paiments"> 
						@csrf 
