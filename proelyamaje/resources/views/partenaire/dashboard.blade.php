@extends("layouts.apps")
						...
						<div class="card radius-10 overflow-hidden bg-gradient-cosmic">
							<div class="card-body">
								<div class="d-flex align-items-center">
									<div>
										<p class="mb-0 text-white">Commission mensuelle cours partenaire</p>
							...
							<div class="card-body">
								<div class="d-flex align-items-center">
									<div>
										...
										<h5 class="mb-0 text-white">{{ number_format($commission, 2, ',', '') }} €  ventes</h5>
									</div>
									<div class="ms-auto text-white"><i class="fadeIn animated bx bx-euro font-30"></i>
									</div>
								</div>
			  ...
			  <div class="row">
			    <div class="col-12 col-xl-12 d-flex">
				  <div class="card radius-10 w-100" id="cardp">
						<div class="card-body">
						<h6 class="mb-0 font-weight-bold">Performances Partenaire</h6>
						...
						<div class="mb-3 d-flex w-100 justify-content-around align-items-baseline flex-wrap">
								<form class="d-flex align-items-center" method="post" action="{{ route('partenaire.dashboard') }}">
									@csrf
									<select id="date_from" name="date_from" class="form-select" aria-label="Default select example" style="width:auto;float:left;" required>
									...
									<button type="button" id="validercharts_1" value="Appliquer" style="margin-left:1%;width:120px;height:40px;border-radius:5px;color:white;border:2px solid black;border-color:black;background-color:black">Rechercher</button><br/>
			...
			<div class="row mb-3" style="margin-bottom:25px !important">
				<div class="col-12 col-lg-6">
					<div class="card radius-10 h-100">
						<div class="card-body">
							<div class="d-flex align-items-center">
								<h6 class="mb-0 font-weight-bold">Nombre de ventes mensuelle en cours</h6>
								...
								@foreach($array_list as $resultat)
									<div class="d-flex align-items-center py-3 border-bottom cursor-pointer">
										<div class="product-img me-2">
											...
											@endif
											<!-- <img class="img-profile" src="{{ asset('admin/uploads/default_avatar.png' )}}" style="border-radius:10px;" style="width:45px;height:45px;"> -->
										</div>
										<div class="">
				...
				<div class="col-12 col-lg-6 commission_mensuelle_progress">
					<div class="card radius-10 h-100">
						<div class="card-body" style="position: relative;">
							<div class="d-flex align-items-center">
								<h6 class="mb-0 font-weight-bold">Commission  mensuel en cours</h6>
							</div>
								<div class="d-flex align-items-center">
									<div class="w-100">
	...
	$("#validercharts_1").on("click", function(){
		$.ajax({
		url: "{{ route('partenaire.getChartParte') }}",
		method: 'GET',
...
//       title: {
//         display: true,
//         text: 'Performance Ambassadrices 2022'
//       }
//     }
// });
