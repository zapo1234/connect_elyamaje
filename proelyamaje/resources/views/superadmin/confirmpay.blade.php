...
<html>
  ...
  <body>
    <div class="response"> 
      <!-- Sidebar - Brand -->
    <div id="imc"><img src="https://connect.elyamaje.com/admin/img/Logo_elyamaje.png" width="100px" height="auto" style="margin-top:100px;"></div>

     <div class="h2" style="text-align:center">L'opération as bien reussie, vous pouvez continuez les paiments! </div>
     <div class="loading">
    ...
    <script type="text/javascript">
      function redirection() {
        window.location.replace("https://www.connect.elyamaje.com/ambassadrice/factures");
      }      
