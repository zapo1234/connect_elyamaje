				...
				<div class="card card_table_mobile_responsive">
					<div class="card-body">
						...
						<div class="table-responsive p-3">
							...
							<table id="example" class="table_mobile_responsive table table-striped table-bordered mb-o" style="width:100%;text-align:center;">
								<thead>
									<tr>
								...
								<tbody>
								 @foreach($lists as $resultat)
									<tr>
										...
										<td data-label="Notification">{{ $resultat['description'] }} </td>
