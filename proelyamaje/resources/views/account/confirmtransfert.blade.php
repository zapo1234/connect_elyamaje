...
<html>
  <head>
    ...
    <link
     ...
     <style type = "text/css">
        ...
        .response{width:30%;margin:auto;font-size:25px;}
         h2{color:black;font-weight:bold;font-size:30px;margin-top:100px;}
  ...
  <body>
    ...
    <div class="imc" style="margin-top:100px"><img id="imj" src="https://erp.elyamaje.com/admin/img/Logo_elyamaje.png" width="105px";
     ...
     <div class="h2">La commande est bien transférée dans notre compte woocoomerce ! </div>
     <div class="loading">
    ...
    <script type="text/javascript">
      function redirection() {
        window.location.replace("https://www.connect.elyamaje.com/index.php/distributeur/orders/transfert");
      }      
