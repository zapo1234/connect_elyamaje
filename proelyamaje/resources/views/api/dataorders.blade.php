                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="card-title">
                                        <h5 class="mb-0">Orders Ambassadrices</h5>
                                    </div>
                                    <hr/>
                                    <div class="row row-cols-auto g-3">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Transférez des commandes ayant un code promo(Ambassadrice && Partenaire) </h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            
                                                            <form method="post" id="transfers_code_promo" action="/datas/api/code_promos">
                                                              @csrf
                                            ...
                                            <div class="modal fade" id="exampleVerticallycenteredModal" tabindex="-1" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                          ...
                                                          <form method="post" id="transfers_orders_api" action="/data/apiaction">
                                                          @csrf
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">Importer des commanndes depuis API woocomerce dans dolibars</h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                        ...
                                        <div class="col">
                                            <!-- Button trigger modal -->
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleVerticallycenteredModals">Orders Annulées</button>
                                            <!-- Modal -->
                                            <div class="modal fade" id="exampleVerticallycenteredModals" tabindex="-1" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        
                                                         <form method="post" id="transfers_order_refunded" action="/datas/refunded/A">
                                                         @csrf
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">Recupérer les commandes annulées (Ambassadrice)</h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body"><br/>
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="annulers">Annuler</button>
                                                            <button type="submit"  id="transfers_api_refunded" class="envoi"><i class="fas fa-download fa-sm text-white-50"></i>Recupérer</button>
                                                        </div>
                                                    </div>
                                                    </form>
                                                </div>
