...
<html>
  ...
  <body>
    <div class="response"> 
      <!-- Sidebar - Brand -->
    <div><img id="imj" src="https://prodev.elyamaje.com/admin/img/Logo_elyamaje.png" width="95px";
					height="auto"; style="";></div>

     <h1><i class='far fa-check-circle' style='font-size:26px;color:green'></i>  Un instant des commandes importées <br/> avec succès ! </h1><br/>
