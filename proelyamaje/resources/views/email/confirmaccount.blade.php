            ...
            <table style="border-style:solid; border-width:1px; border-color:#edeff1;" width="auto" border="0" cellspacing="0" cellpadding="25">
                <tr>
                    <td align="center">
                        ...
                        <p>Veuillez cliquer sur le lien ci-dessous pour confirmer la création de votre compte</p>
                        <p style="width:fit-content;"><a style="padding:15px;background-color:#000000;display:block;text-decoration:none; color:#ffffff" href="{{ route('auth.passwords.confirmaccount', ['token' => $token, 'email' => $email ]) }}">Confirmer mon compte !</a></p>
