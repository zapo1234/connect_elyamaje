            ...
            <table style="border-style:solid; border-width:1px; border-color:#edeff1;" width="auto" border="0" cellspacing="0" cellpadding="25">
                <tr>
                    <td align="center">
                        ...
                        <h3>Souhaitez-vous être payé par bon d'achat ?</h3>
                        <p>Cliquer le bouton continuer pour confirmer votre choix</p>
                        <p style="width:fit-content;"><a style="padding:15px;background-color:#000000;display:block;text-decoration:none; color:#ffffff" href="{{ route('partenaire.paiementusers', ['code_amba' => $code_amba, 'token'=>$token]) }}">Continuez ici</a></p>
